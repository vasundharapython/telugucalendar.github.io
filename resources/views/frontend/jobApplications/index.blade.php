        ...
        <div class="col-md-12">
            @can('job_application_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.job-applications.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $jobApplication->id }}">
                                        ...
                                        <td>
                                            ...
                                            @can('job_application_delete')
                                                <form action="{{ route('frontend.job-applications.destroy', $jobApplication->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('job_application_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.job-applications.massDestroy') }}",
