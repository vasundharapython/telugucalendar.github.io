                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.months.update", [$month->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="month" id="month" value="{{ old('month', $month->month) }}">
                            @if($errors->has('month'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $month->date) }}">
                            @if($errors->has('date'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('date') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pandugalu" id="pandugalu" value="{{ old('pandugalu', $month->pandugalu) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="govtselavu" id="govtselavu" value="{{ old('govtselavu', $month->govtselavu) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="upavasalu" id="upavasalu" value="{{ old('upavasalu', $month->upavasalu) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="importantdays" id="importantdays" value="{{ old('importantdays', $month->importantdays) }}">
