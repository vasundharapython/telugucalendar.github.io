                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.days.update", [$day->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $day->date) }}" required>
                            @if($errors->has('date'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="suryodayam" id="suryodayam" value="{{ old('suryodayam', $day->suryodayam) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="suryastamam" id="suryastamam" value="{{ old('suryastamam', $day->suryastamam) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="shubasamayamulu" id="shubasamayamulu" value="{{ old('shubasamayamulu', $day->shubasamayamulu) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="amruthagadiyalu" id="amruthagadiyalu" value="{{ old('amruthagadiyalu', $day->amruthagadiyalu) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sygerionmuhurthalu" id="sygerionmuhurthalu" value="{{ old('sygerionmuhurthalu', $day->sygerionmuhurthalu) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="thidhi" id="thidhi" value="{{ old('thidhi', $day->thidhi) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nakshatram" id="nakshatram" value="{{ old('nakshatram', $day->nakshatram) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="yogam" id="yogam" value="{{ old('yogam', $day->yogam) }}" required>
                            @if($errors->has('yogam'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('yogam') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="karanam" id="karanam" value="{{ old('karanam', $day->karanam) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="rahukalam" id="rahukalam" value="{{ old('rahukalam', $day->rahukalam) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="yamagandam" id="yamagandam" value="{{ old('yamagandam', $day->yamagandam) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="durmuhurtham" id="durmuhurtham" value="{{ old('durmuhurtham', $day->durmuhurtham) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="varjyamu" id="varjyamu" value="{{ old('varjyamu', $day->varjyamu) }}" required>
