...
@can('bhagavathgeetha_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.bhagavathgeethas.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Bhagavathgeetha">
            <thead>
                <tr>
                    <th width="10">
...
@can('bhagavathgeetha_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.bhagavathgeethas.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.bhagavathgeethas.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Bhagavathgeetha').DataTable(dtOverrideGlobals);
