...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.horoscopedetails.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_of_birth') ? 'is-invalid' : '' }}" type="text" name="time_of_birth" id="time_of_birth" value="{{ old('time_of_birth') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place_of_birth') ? 'is-invalid' : '' }}" type="text" name="place_of_birth" id="place_of_birth" value="{{ old('place_of_birth', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('problem_details') ? 'is-invalid' : '' }}" name="problem_details" id="problem_details" required>{{ old('problem_details') }}</textarea>
