...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.muhurthambooking.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.muhurthambookings.update", [$muhurthambooking->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="full_name">{{ trans('cruds.muhurthambooking.fields.full_name') }}</label>
                <input class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" type="text" name="full_name" id="full_name" value="{{ old('full_name', $muhurthambooking->full_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_name') ? 'is-invalid' : '' }}" type="text" name="spouse_name" id="spouse_name" value="{{ old('spouse_name', $muhurthambooking->spouse_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stars') ? 'is-invalid' : '' }}" type="text" name="stars" id="stars" value="{{ old('stars', $muhurthambooking->stars) }}" required>
                @if($errors->has('stars'))
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('seeking_muhurtham') ? 'is-invalid' : '' }}" type="text" name="seeking_muhurtham" id="seeking_muhurtham" value="{{ old('seeking_muhurtham', $muhurthambooking->seeking_muhurtham) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place_of_muhurtham') ? 'is-invalid' : '' }}" type="text" name="place_of_muhurtham" id="place_of_muhurtham" value="{{ old('place_of_muhurtham', $muhurthambooking->place_of_muhurtham) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_details') ? 'is-invalid' : '' }}" type="text" name="contact_details" id="contact_details" value="{{ old('contact_details', $muhurthambooking->contact_details) }}" required>
