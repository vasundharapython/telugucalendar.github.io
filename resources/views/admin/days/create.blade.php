    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.days.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('suryodayam') ? 'is-invalid' : '' }}" type="text" name="suryodayam" id="suryodayam" value="{{ old('suryodayam') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('suryastamam') ? 'is-invalid' : '' }}" type="text" name="suryastamam" id="suryastamam" value="{{ old('suryastamam') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thidhi') ? 'is-invalid' : '' }}" type="text" name="thidhi" id="thidhi" value="{{ old('thidhi', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nakshatram') ? 'is-invalid' : '' }}" type="text" name="nakshatram" id="nakshatram" value="{{ old('nakshatram', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rahukalam') ? 'is-invalid' : '' }}" type="text" name="rahukalam" id="rahukalam" value="{{ old('rahukalam', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yamagandam') ? 'is-invalid' : '' }}" type="text" name="yamagandam" id="yamagandam" value="{{ old('yamagandam', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('durmuhurtham') ? 'is-invalid' : '' }}" type="text" name="durmuhurtham" id="durmuhurtham" value="{{ old('durmuhurtham', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('varjyamu') ? 'is-invalid' : '' }}" type="text" name="varjyamu" id="varjyamu" value="{{ old('varjyamu', '') }}" required>
