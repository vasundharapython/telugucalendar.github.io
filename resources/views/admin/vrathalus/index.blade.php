...
@can('vrathalu_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.vrathalus.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Vrathalu">
            <thead>
                <tr>
                    <th width="10">
...
@can('vrathalu_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.vrathalus.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.vrathalus.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Vrathalu').DataTable(dtOverrideGlobals);
