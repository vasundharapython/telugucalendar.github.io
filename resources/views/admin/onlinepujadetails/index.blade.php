...
@can('onlinepujadetail_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.onlinepujadetails.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Onlinepujadetail">
            <thead>
                <tr>
                    <th width="10">
...
@can('onlinepujadetail_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.onlinepujadetails.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.onlinepujadetails.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'full_name', name: 'full_name' },
{ data: 'details_of_program', name: 'details_of_program' },
{ data: 'place_of_program', name: 'place_of_program' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Onlinepujadetail').DataTable(dtOverrideGlobals);
