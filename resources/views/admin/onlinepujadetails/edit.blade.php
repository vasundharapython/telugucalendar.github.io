...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.onlinepujadetails.update", [$onlinepujadetail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="full_name">{{ trans('cruds.onlinepujadetail.fields.full_name') }}</label>
                <input class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" type="text" name="full_name" id="full_name" value="{{ old('full_name', $onlinepujadetail->full_name) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('details_of_program') ? 'is-invalid' : '' }}" name="details_of_program" id="details_of_program">{{ old('details_of_program', $onlinepujadetail->details_of_program) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place_of_program') ? 'is-invalid' : '' }}" type="text" name="place_of_program" id="place_of_program" value="{{ old('place_of_program', $onlinepujadetail->place_of_program) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_time') ? 'is-invalid' : '' }}" type="text" name="date_time" id="date_time" value="{{ old('date_time', $onlinepujadetail->date_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_details') ? 'is-invalid' : '' }}" type="text" name="contact_details" id="contact_details" value="{{ old('contact_details', $onlinepujadetail->contact_details) }}">
