    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.months.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('month') ? 'is-invalid' : '' }}" name="month_id" id="month_id" required>
                    @foreach($months as $id => $entry)
                        <option value="{{ $entry }}" {{ old('month_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('month'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pandugalu') ? 'is-invalid' : '' }}" type="text" name="pandugalu" id="pandugalu" value="{{ old('pandugalu', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('govtselavu') ? 'is-invalid' : '' }}" type="text" name="govtselavu" id="govtselavu" value="{{ old('govtselavu', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('upavasalu') ? 'is-invalid' : '' }}" type="text" name="upavasalu" id="upavasalu" value="{{ old('upavasalu', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('importantdays') ? 'is-invalid' : '' }}" type="text" name="importantdays" id="importantdays" value="{{ old('importantdays', '') }}">
