...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.monthMi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.month-mis.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rahukalam') ? 'is-invalid' : '' }}" type="text" name="rahukalam" id="rahukalam" value="{{ old('rahukalam', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yamagandam') ? 'is-invalid' : '' }}" type="text" name="yamagandam" id="yamagandam" value="{{ old('yamagandam', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('durmuhurtham') ? 'is-invalid' : '' }}" type="text" name="durmuhurtham" id="durmuhurtham" value="{{ old('durmuhurtham', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thidhi') ? 'is-invalid' : '' }}" type="text" name="thidhi" id="thidhi" value="{{ old('thidhi', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nakshatram') ? 'is-invalid' : '' }}" type="text" name="nakshatram" id="nakshatram" value="{{ old('nakshatram', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('varjyam') ? 'is-invalid' : '' }}" type="text" name="varjyam" id="varjyam" value="{{ old('varjyam', '') }}">
