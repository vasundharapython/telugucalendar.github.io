    ...
    <div class="container-fluid px-1 box12">
        ...
        <div class="row d-flex justify-content-center mt-5">
            <div class="col-lg-7 col-md-12 col-sm-12 mb-3 col-xs-12">
                <div class="card">
                    <h5 class="text-center mb-4">Know your Horoscope remedies according to Astrology / మీ జాతక పరిహారాలు తెలుసుకోండి</h5>
                    <form method="POST" action="{{route('horoscopes.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-between text-left">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Date Of Birth<span class="text-danger"> *</span></label> <input type="date" id="lname" name="date_of_birth" required> </div>
                        </div>
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Time Of Birth<span class="text-danger"> *</span></label> <input type="time" id="lname" name="time_of_birth" required> </div>
                            <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label ">Place of Birth ( City, District, State and Country. )<span class="text-danger"> *</span></label> <input type="text" id="address" name="place_of_birth" required> </div>
                        </div>
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Tell us your problem in brief<span class="text-danger"> *</span></label> <textarea type="text" id="email" name="problem_details" placeholder="" required></textarea> </div>
