...
<body style="font-family: Ramabhadra; font-size: 22px;">
    ...
    <section class="layout11">
        <div class="grow1 bg-white boxs text-info text-center brb "> <a href = "{{url('calendar')}}"><button class = "success"><h3 class = "text-info">మాస వీక్షణ</h3></button></a></div>
    </section>
            ...
            <div>
                <div class="text-center">
                   ...
                   {{-- @php
                    ...
                    <input id = "date" type = "hidden" value = "{{$cld->date}}">
                    {{--<h3 id = "date">{{$cld->date}}</h3>--}}
                    @endforeach
...
<div class="container-fluid bg-white p-3 shadow px-3 mt-3">
  <section class="layout2">
    ...
    <section class="layout3">
      ...
      <div class="text-center">  <p id = "varjyamu"></p>{{--{{$cld->varjyamu}}--}}</div>
    </section>
  ...
  @include('include.footer')
        ...
        loadDataForDate();
            ...
            <script>
                ...
                if (dateParts.length === 3) {
                    ...
                    var  ate= new Date(day, month, year);
                    console.log(ate)
    ...
    currentDateElement.textContent = displayString;
                ...
                function loadDataForDate(date) {
                    ...
                    /*var dav = new Date(date);
                    var da = dav.getDate();
                    da+=1;
                    var mo = dav.getMonth();
                    mo+=1;
                    var ye = dav.getFullYear();
                    var newDate=(ye+ "-" + mo + "-" + da);
                    console.log(newDate);*/
                    fetch(`/fetch-data/${date}`)
                        .then(response => response.json())
                        .then(data => {
                ...
                /*function handleDateSelection(newDate) {
                    // Call the 'loadDataForDate' function with the selected date
